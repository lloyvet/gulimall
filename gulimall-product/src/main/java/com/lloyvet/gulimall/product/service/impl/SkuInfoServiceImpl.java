...
import com.lloyvet.gulimall.product.dao.SkuInfoDao;
import com.lloyvet.gulimall.product.entity.SkuInfoEntity;
import com.lloyvet.gulimall.product.service.SkuInfoService;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public List<SkuInfoEntity> getSkusBySpuId(Long spuId) {
        List<SkuInfoEntity> skuInfoEntities = this.list(new QueryWrapper<SkuInfoEntity>().eq(spuId != null, "spu_id", spuId));
